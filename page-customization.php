...
<div class="m-flow" id="formula-steps">
  ...
  <section class="m-modal__scene" id="formula__step_zero">
  ...
  <section class="m-modal__scene js--active" id="formula__step_one">
    <div class="m-container"> 
      <div class="m-formula">
        ...
        <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Sí" data-scene-in="formula__step_two" data-scene-out="formula__step_one" data-step="1" data-value="Sí"><span>Sí</span></a>
        <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="No" data-scene-in="formula__step_two" data-scene-out="formula__step_one" data-step="1" data-value="No"><span>No</span></a>
      </div>
      ...
      <div class="m-formula">
        ...
        <div class="m-formula__content"> 
          <div class="m-formula__option">
            ...
            <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Seco"data-scene-in="formula__step_three" data-scene-out="formula__step_two" data-step="2" data-value="Seco"><span>Seco</span></a>
          </div>
          ...
          <div class="m-formula__option">
            ...
            <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Normal"data-scene-in="formula__step_three" data-scene-out="formula__step_two" data-step="2" data-value="Normal"><span>Normal</span></a>
          </div>
          ...
          <div class="m-formula__option">
            ...
            <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Graso"data-scene-in="formula__step_three" data-scene-out="formula__step_two" data-step="2" data-value="Graso"><span>Graso</span></a>
          </div>
      ...
      <div class="m-formula">
        ...
        <div class="m-formula__content"> 
          <div class="m-formula__option"> 
            ...
            <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Crespo" data-scene-in="formula__step_four" data-scene-out="formula__step_three" data-step="3" data-value="Crespo"><span>Crespo</span></a>
          </div>
          ...
          <div class="m-formula__option"> 
            ...
            <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Ondulado" data-scene-in="formula__step_four" data-scene-out="formula__step_three" data-step="3" data-value="Ondulado"><span>Ondulado</span></a>
          </div>
          ...
          <div class="m-formula__option"> 
            ...
            <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" title="Lacio" data-scene-in="formula__step_four" data-scene-out="formula__step_three" data-step="3" data-value="Lacio"><span>Lacio</span></a>
          </div>
    ...
    <div class="m-container"> 
      <div class="m-formula">
        ...
        <div class="m-formula__options">
          ...
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Hidratación profunda" data-step="4" data-max-options="3" data-value="Hidratación profunda"><span>Hidratación profunda</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Fortalecimiento" data-step="4" data-max-options="3" data-value="Fortalecimiento"><span>Fortalecimiento</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Anti frizz" data-step="4" data-max-options="3" data-value="Anti frizz"><span>Anti frizz</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Prevención caída" data-step="4" data-max-options="3" data-value="Prevención caída"><span>Prevención caída</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Brillo extremo" data-step="4" data-max-options="3" data-value="Brillo extremo"><span>Brillo extremo</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Alisado" data-step="4" data-max-options="3" data-value="Alisado"><span>Alisado</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Protección del color" data-step="4" data-max-options="3" data-value="Protección del color"><span>Protección del color</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Volumen" data-step="4" data-max-options="3" data-value="Volumen"><span>Volumen</span></a>
          <a class="m-button m-scene-option" href="javascript:void(0)" data-scene-in="formula__step_five" data-scene-out="formula__step_four" title="Anticaspa" data-step="4" data-max-options="3" data-value="Anticaspa"><span>Anticaspa</span></a>
        </div>
      </div>
      <div class="m-buttons">
        ...
        <div class="m-formula__fragances">
          ...
          <div class="m-formula__fragance">
            ...
            <div class="m-formula__fragance__box">
              ...
              <a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_seven" data-scene-out="formula__step_five" data-step="5" data-value="Sweet Pear"><span>Sweet Pear</span></a>
            </div>
          </div>
          ...
          <div class="m-formula__fragance">
            ...
            <div class="m-formula__fragance__box">
              ...
              </div><a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_seven" data-scene-out="formula__step_five" data-step="5" data-value="Coco Tropical"><span>Coco Tropical</span></a>
            </div>
          </div>
          <?php /* ?>
          <!--div class="m-formula__fragance">
          ...
          <div class="m-formula__fragance">
            ...
            <div class="m-formula__fragance__box">
              ...
              </div><a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_seven" data-scene-out="formula__step_five" data-step="5" data-value="Manzana reverde"><span>Manzana reverde</span></a>
            </div>
          </div>
          <div class="m-formula__fragance">
            <div class="m-formula__fragance__specifications">
            ...
            <div class="m-formula__fragance__box">
              ...
              </div><a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_seven" data-scene-out="formula__step_five" data-step="5" data-value="Brisa marina"><span>Brisa marina</span></a>
            </div>
          </div>
          <div class="m-formula__fragance">
            <div class="m-formula__fragance__box">
              ...
              </div><a class="m-button m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_seven" data-scene-out="formula__step_five" data-step="5" data-value="Sin fragancia"><span>Sin fragancia</span></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="m-container"> 
      <div class="m-formula">
        ...
        <div class="m-bottles">
          ...
          <a class="m--white m-scene-option m-scene-button js--active" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="white" data-product="shampoo"><span>white</span></a>
          <a class="m--light-blue m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="light-blue" data-product="shampoo"><span>light-blue</span></a>
          <a class="m--pink m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="pink" data-product="shampoo"><span>pink</span></a>
          <a class="m--orange m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="orange" data-product="shampoo"><span>orange</span></a>
          <a class="m--green m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="green" data-product="shampoo"><span>green</span></a>
          <a class="m--purple m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="purple" data-product="shampoo"><span>purple</span></a>
          <a class="m--yellow m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="yellow" data-product="shampoo"><span>yellow</span></a>
          <!--a class="m--gray m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_eight" data-scene-out="formula__step_seven" data-step="7" data-value="gray" data-product="shampoo"><span>gray</span></a-->
    ...
    <div class="m-container"> 
      <div class="m-formula">
        ...
        <div class="m-bottles">
          ...
          <a class="m--white m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="white" data-product="acondicionador"><span>white</span></a>
          <a class="m--light-blue m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="light-blue" data-product="acondicionador"><span>light-blue</span></a>
          <a class="m--pink m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="pink" data-product="acondicionador"><span>pink</span></a>
          <a class="m--orange m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="orange" data-product="acondicionador"><span>orange</span></a>
          <a class="m--green m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="green" data-product="acondicionador"><span>green</span></a>
          <a class="m--purple m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="purple" data-product="acondicionador"><span>purple</span></a>
          <a class="m--yellow m-scene-option m-scene-button" href="javascript:void(0)" data-scene-in="formula__step_ten" data-scene-out="formula__step_eight" data-step="8" data-value="yellow" data-product="acondicionador"><span>yellow</span></a>
          <!--a class="m--gray m-scene-option m-scene-button" href="javascript:void(0)" data-step="8" data-value="gray" data-product="acondicionador"><span>gray</span></a-->
...
<!--
				<?php
				echo "<div class='test'><span><a href='https://www.vua.pe/?add-to-cart=" . $product->ID . "'>-</a> 1 </span><a href='https://www.vua.pe/?add-to-cart=" . $product->ID . "'>+</a></div>"
				?>
-->
			<div class="mainCont">
				<div class="inner">			
					<button class="buttoncol" onclick="changer(-1)">-</button>
              ...
              <form action="?add-to-cart=<?= $product->ID ?>" class="cart" method="post" enctype="multipart/form-data">
                <button type="submit" data-quantity="1"  data-name-product="<?php echo $product->post_title ?>" data-product_id="<?= $product->ID ?>" class="m-button button m-add-to-product alt ajax_add_to_cart add_to_cart_button product_type_simple adder">
...
<script type="text/javascript">
	var num = 1;
	function changer(cant){
		this.num = this.num+cant;	
		if(this.num<1)
			this.num = 1;
		var elements = document.getElementsByClassName("quant");
		for (var i = 0; i < elements.length; i++) {
		  elements[i].innerHTML = this.num;
		}
		console.log("Track: ", "?add-to-cart=<?= $product->ID ?>&quantity="+this.num)
		var buttons = document.getElementsByClassName("cart");
		var addes = document.getElementsByClassName("adder");
		console.log("Addes", addes)
		for (var i = 0; i < buttons.length; i++) {
		  buttons[i].action = "?add-to-cart=<?= $product->ID ?>&quantity="+this.num;
			
		}		
		var addes = document.getElementsByClassName("adder");
		for (var i = 0; i < addes.length; i++) {
		  addes[i].dataset.quantity = this.num;
		}		
	}
