...
<script>
	document.querySelector('.woocommerce-MyAccount-navigation-link--edit-address span').innerHTML = 'Dirección de envío'
</script>
...
<script>
	$('table').addClass('m-account-table');
</script>