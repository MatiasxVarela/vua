...
<div class="woocommerce-customer-details" style="width:100%;vertical-align:top;margin-bottom:40px;padding:0">
	<h2 style="color:#d0a8e8;display:block;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;font-size:18px;font-weight:bold;line-height:130%;margin:0 0 18px;text-align:left">Detalle de los productios</h2>
...
<p style="margin: 20px 0; font-size: 13px;color: #404040; line-height: 1.5;"><strong>* Tu producto llegará máximo de 3 a 6 días útiles. Solo aplica direciones de envío en Lima.</strong></p>
<?php
/**
